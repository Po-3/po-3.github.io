(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      ...
      '#' + WIDGET_ID + ' .tnr-fal-head{margin-bottom:16px;}',
      '#' + WIDGET_ID + ' .tnr-fal-title{margin:0 0 6px;font-size:1.04em;font-weight:700;line-height:1.6;color:#111827;}',
      '#' + WIDGET_ID + ' .tnr-fal-sub{margin:0;font-size:.92em;line-height:1.8;color:#6b7280;}',
      ...
      '#' + WIDGET_ID + ' .tnr-fal-name{margin:0 0 10px;font-size:1em;font-weight:700;line-height:1.6;color:#111827;}',
      '#' + WIDGET_ID + ' .tnr-fal-desc{margin:0 0 14px;font-size:.92em;line-height:1.8;color:#4b5563;flex:1;}',
      ...
      '  #' + WIDGET_ID + ' .tnr-fal-grid{grid-template-columns:repeat(2,minmax(0,1fr));}',
      '}',

      '@media (max-width: 768px){',
      '  #' + WIDGET_ID + '{min-height:auto;}',
